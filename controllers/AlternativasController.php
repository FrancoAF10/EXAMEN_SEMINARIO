...
if (isset($_SERVER['REQUEST_METHOD'])) {
  ...
  require_once "../models/Alternativas.php";
  ...
  switch ($_SERVER["REQUEST_METHOD"]) {
    case "GET":
      ...
      //DEBEMOS IDENTIFICAR SI EL USUARIO REQUIERE LISTAR
        if ($_GET["task"] == 'getAll') {
            echo json_encode($alternativas->getAll());
        }
    break;
    ...
    case "POST":
      ...
      $registro = [
        ...
        "esCorrecto"        => $dataJSON["esCorrecto"],
        "idInterrogante"    => $dataJSON["idInterrogante"],
      ];
      //Obtenemos el número de registros
      $filasAfectadas = $alternativas->add($registro);
